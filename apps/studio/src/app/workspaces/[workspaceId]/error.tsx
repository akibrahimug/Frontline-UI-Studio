  ...
  const getErrorMessage = () => {
    ...
    if (message === "WORKSPACE_NOT_FOUND") {
      return {
        ...
        description:
          "The workspace you're trying to access doesn't exist or has been deleted.",
      };
    }
    ...
    if (message === "WORKSPACE_ACCESS_DENIED") {
      return {
        title: "Access Denied",
        description:
          "You don't have permission to access this workspace. You need to be invited as a member.",
        helpText:
          "Contact the workspace owner and ask them to add you as a member to access this workspace.",
      };
    }
    ...
    return {
      ...
      description:
        "An error occurred while loading the workspace. Please try again.",
    };
  };
